...
pub const BUT_SLOTSUNLOKING_CFG: ButtonCFG = ButtonCFG {
    pos: Vec2::new(224.0, -50.0),
...
pub const SLOT_PRICES: SlotPrices = SlotPrices {
    prices: &[50.0, 100.0, 200.0, 350.0, 500.0, 750.0, 
    1000.0, 1350.0, 1800.0, 2400.0, 3200.0, 4500.0],
};


// pub const TOMATO_LIMIT_PRICES: [f64; 4] = [10.0, 30.0, 80.0, 200.0];

// pub const CUCUMBER_LIMIT_PRICES: [f64; 4] = [250.0, 500.0, 900.0, 1500.0];

// pub const CORN_LIMIT_PRICES: [f64; 4] = [1800.0, 3000.0, 4500.0, 6500.0];

// pub const PUMPKIN_LIMIT_PRICES: [f64; 4] = [8000.0, 12000.0, 18000.0, 25000.0];

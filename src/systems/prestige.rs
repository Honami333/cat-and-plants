...
pub fn prestige_flag(
    ...
    *fonts_loaded = func_fonts_loaded(ctx, *fonts_loaded, &all_fonts, &font);
    ...
    let Some(prestige_cost) = current_world.get_prestige_cost() else { return; };
                ...
                if !*confirmation {
                    ui.add_enabled_ui(*is_prestige, |ui| {
                        let response = ui.add_sized([120.0 * s, 25.0 * s], egui::Button::new(
                            egui::RichText::new("PRESTIGE!").heading().color(egui::Color32::GOLD))
                        );
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if response.clicked() {
                            ...
                            *pr_room += 1;
                            ...
                            economy.add_sparcks(sparks as usize, (*pr_room as f64).powf(1.2).floor());
                        };
                ...
                *is_prestige = true;
                ...
                ui.vertical(|ui| {
                    for (i, res) in res_type.iter().enumerate() {
                        ...
                        let Some(required_amount) = prestige_cost.get(i) else { continue; };
                        ...
                        if *prestige {
                            economy.add(*res as usize, -*required_amount);
                        };
